...
\begin{figure}
	\centering
	\includegraphics[width=0.8\columnwidth]{fig/dubins_ic}
...
\begin{figure}
	\centering
	\includegraphics[width=0.9\columnwidth]{fig/dubins_reach_all}
...
\begin{figure}
	\centering
	\includegraphics[width=0.9\columnwidth]{fig/dubins_result}
