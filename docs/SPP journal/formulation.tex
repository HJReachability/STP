...
\SBnote{Let's make sure that we do not claim that the state space is different across vehicles; otherwise, we have to formally define generalized relative coordinates.}
