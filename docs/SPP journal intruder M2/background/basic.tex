...
The majority of the content in this section is taken from \cite{Chen15c}. Recall that among the STP vehicles $\veh_i, i=1,\ldots,N$, $\veh_j$ has a higher priority than $\veh_i$ if $j<i$. In the absence of disturbances, we can write the dynamics of the STP vehicles as
\begin{equation}
