...
\SetKwInOut{Output}{output}
	...
	\For{\text{$i=1:N$}}{
			...
			compute the avoidnace controller $\ctrl^{\text{A}}_i$ using \eqref{eqn:optAvoidCtrl}; \;
			...
			given the nominal controller ${\ctrl^{\text{PP}}_{i}}(\cdot)$ and the BRS $\brs^{\text{PP}}_{i}(t, \sta_i)$, compute the base obstacles $\boset_i(\cdot)$ using equations (25), (31) or (37) in \cite{chen2016robust}, depedning on the information assumed to be known about the higher-priority vehicles.
		}
\end{algorithm}
%