...
\SBnote{Explain the computation of base obstacle a bit more here. Maybe try to relate back to the mentioned equations and say something about the computation.}
...
\SBnote{After the details of the method describe the built-in conservatism and how to overcome that. Or refer to the discussion section.}