...
\begin{table*}
 ...
 %   \begin{tabular}{ | l | l | p{11cm} |}
    ...
    $\rvs$ & - & Equation \eqref{eq:RVS} & The set of vehicles that need to replan their path after the intruder disappears. These are also the set of vehicles that were forced to apply an avoidance maneuver. \\ \hline
