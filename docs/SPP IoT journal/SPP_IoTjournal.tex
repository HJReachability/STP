...
\newcommand{\dsen}{d^\text{S}} % Sensing distance
...
\input{./intruder/sepRegion}
\input{./intruder/case1}
%\input{./intruder/case2}
%\input{./intruder/buffRegion}
%\input{./intruder/obstacles}
\input{./intruder/plan}
