...
\begin{figure}[h]
  ...
  \caption{Evolution of the BRS for $\veh_3$ in the least restrictive control method. $\ldt_3$ is significantly lower than that in the centralized controller method ($-1.96$ vs. $-2.68$), reflecting the impact of bigger induced obstacles.}
  \label{fig:lrc_rs3}
\end{figure}