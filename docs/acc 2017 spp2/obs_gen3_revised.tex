...
H_j\left(t, e_j, p\right) = \max_{u_j \in \cset_j} \min_{u_r \in\cset^p_j, d_j \in \dset_j} \lambda \cdot f_{e_j}(t, e_j, u_j, u_r,d_j)
\end{equation}
