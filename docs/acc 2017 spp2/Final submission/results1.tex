...
\SBnote{Take out the unnecessary sentences that are just being repeated.}
\SBnote{Maybe have a single plot with 4 subplots showing problem setup and overall trajectories for 3 algorithms.}
\SBnote{Have a single plot with 9 subplots showing BRSs, 3 for each case.}
\SBnote{Take out the unnecessary explanation like ``carving out channels" from the description.}  
