...
Fig. \ref{fig:trajsRTT} shows vehicle trajectories in the situation where each vehicle robustly tracks a nominal trajectory. Fig. \ref{fig:rtt_rs3} shows the BRS evolution and induced obstacles for $\veh_3$. %The obstacles induced by other vehicles inhibit the evolution of the BRS, carving out thin “channels,” which can be seen at $t = -2.59$, that separate the BRS into different “islands”. %One can see how these channels and islands form by examining the time evolution of the BRS set.
%
%\begin{figure}[H]
%  \centering
