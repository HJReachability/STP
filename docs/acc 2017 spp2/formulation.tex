...
\MCnote{Throughout the paper, we will assume that the priority ordering is given, and derive safe optimal trajectories based on the given priority ordering. The way to assign priorities is not the focus of this paper, but this important problem will be considered as part of future work.}