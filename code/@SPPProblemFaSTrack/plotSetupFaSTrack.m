function f = plotSetupFaSTrack(obj, setup_name, save_png)
% plotSetupFaSTrack(obj)
...
if ~isempty(obj.staticObs)
  ...
  obs_no_border = obj.staticObs;  %%%%%%%%%%%%%%%%% staticObs shouldn't have a border, only augStaticObs
