function hamValue = dubins3DPEham_2Rcal(t, data, deriv, schemeData)
...
if strcmp(schemeData.PEmode, '2Rcal')
  % player 1 minimizes, player 2 minimizes, disturbance minimizes
